...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 02 avr. 2025 à 10:43
...
(1, 'Petit Temps', 5.00, 2, 'Un petit forfait pas chère pour des petites games'),
(2, 'prix moyen', 10.00, 4, 'Un prix moyen pour du plaisir');
...
INSERT INTO `users_packages` (`user_id`, `package_id`, `reservation_date`, `duration`, `status`, `id`) VALUES
(1, 1, '2010-01-01 00:00:00', 2, 'confirmée', 7),
(2, 2, '2025-02-25 21:04:07', 4, 'confirmée', 26),
(2, 2, '2025-02-25 21:04:09', 4, 'confirmée', 27),
(2, 2, '2025-02-25 21:28:56', 4, 'confirmée', 28);
